    ...
    <body>
        ...
        <div id="create-hosts" class="content scaffold-create" role="main">
            ...
            <g:form action="save">
                <fieldset class="form">
                    <!-- <f:all bean="hosts"/> -->
                    <f:field bean="hosts" property="hostname"/>
                    <f:field bean="hosts" property="ipaddress"/>
                    <f:field bean="hosts" property="lifecycle"/>
                    <f:field bean="hosts" property="username"/>
                    <f:field bean="hosts" property="role"/>
                    <f:field bean="hosts" property="room"/>
                    <f:field bean="hosts" property="grid"/>
                </fieldset>
